...
@synthesize difficulty, isPad, isRetina, hasGameCenter, unsentScores, unsentAchievements, achievementsDictionary;
...
- (id)initWithCoder:(NSCoder *)coder
{
	if ((self = [super init])) 
	{
		...
		self.difficulty = [coder decodeIntForKey:@"difficulty"];
	}
	return self;
}
